...
from vivarium_gates_lsff_by_wealth_quintile_child.constants import data_keys, metadata
from vivarium_gates_lsff_by_wealth_quintile_child.tools.app_logging import (
    add_logging_sink,
    decode_status,
)
...
def build_single_location_artifact(
    ...
    from vivarium_gates_lsff_by_wealth_quintile_child.data import builder
    ...
    for key_group in data_keys.MAKE_ARTIFACT_KEY_GROUPS:
        ...
        for key in key_group:
            if key in (data_keys.LBWSG.PAF, data_keys.POPULATION.FERTILITY_DATA) and for_lbwsg_pafs:
                continue
